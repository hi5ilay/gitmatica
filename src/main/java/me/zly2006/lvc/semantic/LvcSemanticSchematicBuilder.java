...
public final class LvcSemanticSchematicBuilder
{
    ...
    public static final class BuildSession
    {
        ...
        public void processNextChunk() throws IOException
        {
            ...
            BuildStats stats = populateSchematicChunk(this.regions, this.containers, this.blockEntityMaps, this.worldOrigin,
                    this.lootPreviewWorld, coordinate, ChunkView.from(chunk));
        ...
        public LitematicaSchematic result()
        {
            ...
            LvcDiagnostics.debug("LvcSemanticSchematicBuilder: built schematic project='{}' regions={} chunks={} blockEntities={} promotedContainerComponents={} materializedContainerLootTables={} failedContainerLootTables={} lootPreviewWorld={}",
                    this.projectName, this.regions.size(), this.chunkRefs.size(), this.blockEntityCount, this.promotedContainerComponents,
    ...
    {
        Map<String, BlockState> blockStateCache = new HashMap<>();
        ...
        return new BuildStats(blockEntityCount, promotedContainerComponents, materializedContainerLootTables, failedContainerLootTables);
    }
    ...
    private record BuildStats(int blockEntities, int promotedContainerComponents, int materializedContainerLootTables,
                              int failedContainerLootTables)
    {
    }

    private record ChunkView(int sizeX, int sizeY, int sizeZ, Map<Integer, String> blockStatesByIndex,
                             Map<Integer, byte[]> blockEntitiesByIndex)
    {
        private static ChunkView from(LvcChunk chunk)
        {
            ...
            return new ChunkView(chunk.sizeX(), chunk.sizeY(), chunk.sizeZ(), Map.copyOf(blockStates), Map.copyOf(blockEntities));
        }
    }
}
