...
- **RVC project**: A Minecraft structure project managed by RVC, stored in a Git repository.
- **Commit**
- **Branch**
- **Merge**
- **Diff**
...
- **Schematic World**: A temporary world created by litematica / RVC to perform verifying and diffing operations.


### Checkout

When checking out a commit or branch, RVC will:
